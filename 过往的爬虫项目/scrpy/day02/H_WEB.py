...
url = 'https://www.232mk.com/pic/1/2015-11-21/187.html'
Headers = {
...
# url_dict = {}
#div class="content"
title_list = ret.xpath('//div[@class="content"]/p/a/@href')
print(title_list)
...
# url_list = ['https://www.232mk.com/pic/1/index_%d.html'% page for page in range(1,36)]
